...
var Primitives = {
    ...
    lineBresenham: function (context, x1, y1, x2, y2, color, dash) {
        var x = x1,
            y = y1,
            dx = x2 - x1,
            dy = y1 - y2,
    ...
    plotCirclePoints: function (context, xc, yc, x, y, color, color2) {
        ...
        for(var a = xc, i = 0; a <= (xc + y); a++, i++){
            this.setPixel(context, a, yc + x, aveR < color[0] ? aveR+i : aveR-i,
                                              aveG < color[1] ? aveG+i : aveG-i,
                                              aveB < color[2] ? aveB+i : aveB-i);
        }
        for(var a = xc, i = 0; a <= (xc + y); a++, i++){
        ...
        //left half
        for(var a = xc, i = 0; a > (xc - x); a--, i++){
            this.setPixel(context, a, yc + y, aveR < color2[0] ? aveR+i : aveR-i,
                                              aveG < color2[1] ? aveG+i : aveG-i,
                                              aveB < color2[2] ? aveB+i : aveB-i);
        }
        for(var a = xc, i = 0; a > (xc - x); a--, i++){
            this.setPixel(context, a, yc - y, aveR < color2[0] ? aveR+i : aveR-i,
                                              aveG < color2[1] ? aveG+i : aveG-i,
        ...
        for(var a = xc, i = 0; a > (xc - y); a--, i++){
            this.setPixel(context, a, yc + x, aveR < color2[0] ? aveR+i : aveR-i,
                                              aveG < color2[1] ? aveG+i : aveG-i,
                                              aveB < color2[2] ? aveB+i : aveB-i);
        }
        for(var a = xc, i = 0; a > (xc - y); a--, i++){
    ...
    // Now DDA.
    circleDDA: function (context, xc, yc, r, color, color2) {
        var epsilon = 1 / r,
            x = r,
            y = 0;
    ...
    circleBres1: function (context, xc, yc, r, color, color2) {
        var p = 3 - 2 * r,
            x = 0,
            y = r;
    ...
    // And another...
    circleBres2: function (context, xc, yc, r, color, color2) {
        var x = 0,
            y = r,
            e = 1 - r,
            u = 1,
    ...
    // Last but not least...
    circleBres3: function (context, xc, yc, r, color, color2) {
        var x = r,
            y = 0,
            e = 0;
