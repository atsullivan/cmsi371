...
(function () {
    ...
    Primitives.lineBresenham(renderingContext, 825, 210, 1024, 110, [0,0,0], 5);

    // A few circles.
    Primitives.circleTrig(renderingContext, 105, 315, 100, [0,0,255], [0,255,0]);
    Primitives.circleDDA(renderingContext, 310, 315, 100, [0,0,255], [0,255,0]);
    Primitives.circleBres1(renderingContext, 515, 315, 100, [0,0,255], [0,255,0]);
    Primitives.circleBres2(renderingContext, 720, 315, 100, [0,0,255], [0,255,0]);
    Primitives.circleBres3(renderingContext, 925, 315, 100, [0,0,255], [0,255,0]);
